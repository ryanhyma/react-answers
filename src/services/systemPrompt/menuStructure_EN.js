export const menuStructure_EN = {
  ...
  'Immigration and citizenship': {
    ...
    topics: {
      ...
      'Express Entry -application process for skilled immigrants who want to settle in Canada permanently':
        'https://www.canada.ca/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry.html',
      ...
      'Get a permanent residence card':
    ...
    mostRequested: {
      ...
      'Book a biometrics collection appointment -Biometric Instruction Letter Application Number':
        'https://eservices.canada.ca/en/reservation/',
      'Check your passport application status':
        'https://www.canada.ca/en/immigration-refugees-citizenship/services/canadian-passports/check-passport-travel-document-application.html',
      'Get urgent or express passport service':
  ...
  'Business and industry': {
    ...
    mostRequested: {
      ...
      "File your corporation's annual return":
        'https://ised-isde.canada.ca/site/corporations-canada/en/keep-your-corporation-good-shape/annual-return',
  ...
  Benefits: {
    ...
    mostRequested: {
      ...
      'Sign in to your My Service Canada Account':
        'https://www.canada.ca/en/employment-social-development/services/my-account.html',
      'Create or register for a My Service Canada Account (MSCA)':
        'https://www.canada.ca/en/employment-social-development/services/my-account/registration.html',
      ...
      'Direct deposit for CPP,OAS, EI':
        'https://www.canada.ca/en/employment-social-development/programs/direct-deposit.html',
    },
  },
  Health: {
  ...
  Taxes: {
    ...
    topics: {
      ...
      'Personal income tax refunds - timelines, check status, transfers':
        'https://www.canada.ca/en/revenue-agency/services/tax/individuals/topics/about-your-tax-return/refunds.html',
      'Personal income tax return':
        'https://www.canada.ca/en/services/taxes/income-tax/personal-income-tax-return.html',
      'Corporation income tax rates credits record-keeping payments and instalments':
      ...
      'Charities and giving - lists, registering, fundraising, compliance, guidance':
    ...
    mostRequested: {
      'Sign in to your CRA Account (to My Account, My Business Account, Represent a Client)':
        'https://www.canada.ca/en/revenue-agency/services/e-services/cra-login-services.html',
      'Register for a CRA Account (to My Account, My Business Account, Represent a Client)':
  ...
  'Policing, justice and emergencies': {
    ...
    mostRequested: {
      'Apply/Renew a firearms licence':
        'http://www.rcmp-grc.gc.ca/cfp-pcaf/online_en-ligne/index-eng.htm',
  ...
  'About government': {
    ...
    topics: {
      ...
      'Pay, pension and benefits for the public service, military and RCMP':
        'https://www.canada.ca/en/government/publicservice/pay.html',
      ...
      'Government communications requirements':
        'https://www.canada.ca/en/treasury-board-secretariat/topics/government-communications.html',
    ...
    mostRequested: {
      ...
      'Pay system and services':
        'https://www.canada.ca/en/public-services-procurement/services/pay-pension/pay-administration.html',
    },
  },
  'Working for the government': {
    ...
    topics: {
      'precautionary measures':
        'https://www.canada.ca/en/government/system/digital-government/online-security-privacy/bgrs-sirva-canada-systems-privacy-breach-affecting-current-former-federal-employees.html',
      ...
      'Services and benefits for the military':
        'https://www.canada.ca/en/government/publicservice/benefitsmilitary.html',
      'Services and benefits for the RCMP':
        'https://www.canada.ca/en/government/publicservice/benefitsrcmp.html',
      ...
      'Innovation in the public service':
        'https://www.canada.ca/en/government/publicservice/modernizing.html',
      'Awards and recognition':
        'https://www.canada.ca/en/treasury-board-secretariat/services/innovation/awards-recognition-special-events.html',
    },
    mostRequested: {
      'Rates of pay': 'https://www.canada.ca/en/treasury-board-secretariat/topics/pay.html#rates',
      'Hybrid work':
        'https://www.canada.ca/en/government/publicservice/modernizing/hybrid-work.html',
      'Collective bargaining':
        'https://www.canada.ca/en/treasury-board-secretariat/services/collective-agreements/collective-bargaining.html',
    },
  },
  'Indigenous Peoples': {
    ...
    topics: {
      ...
      'Education, training and jobs':
        'https://www.canada.ca/en/services/indigenous-peoples/education-training-jobs.html',
      ...
      'Health services and social programs':
        'https://www.canada.ca/en/services/indigenous-peoples/health-services-and-social-programs-indigenous-peoples.html',
      'Treaties, claims and agreements':
        'https://www.rcaanc-cirnac.gc.ca/eng/1100100028568/1529354090684',
      'Business and economic development':
        'https://www.canada.ca/en/services/indigenous-peoples/business-and-economic-development-indigenous-peoples.html',
      'Indigenous justice and policing':
        'https://www.canada.ca/en/services/indigenous-peoples/indigenous-justice-and-policing.html',
      Reconciliation: 'https://www.rcaanc-cirnac.gc.ca/eng/1400782178444/1529183710887',
      'Environment and natural resources':
        'https://www.canada.ca/en/services/indigenous-peoples/environment-and-natural-resources-for-indigenous-peoples.html',
  ...
  'Veterans and military': {
    ...
    topics: {
      ...
      'Military services and benefits':
        'https://www.canada.ca/en/government/publicservice/benefitsmilitary.html',
      'RCMP services and benefits':
        'https://www.canada.ca/en/government/publicservice/benefitsrcmp.html',
      'Education and jobs for Veterans and military members':
        'https://www.canada.ca/en/services/veterans-military/jobs-for-veterans-and-military-members.html',
      'Health and wellness for Veterans and military':
    ...
    mostRequested: {
      ...
      'My VAC Account':
        'https://www.veterans.gc.ca/eng/e_services?utm_source=header&utm_medium=button&utm_campaign=MVA',
      'Military pay':
      ...
      'Mental health and wellness for Veterans':
        'https://www.veterans.gc.ca/en/health-programs-and-services/mental-health-and-wellness',
    },
  },
  'What to do when someone dies': {
    ...
    topics: {
      ...
      "Notify of a death -Who to contact to inform of a death and how to cancel an individual's benefits.":
        'https://www.canada.ca/en/services/death/notify.html',
      'Entitlements to benefits and programs after a death - CPP, Survivors allowance, Veterans, ':
        'https://www.canada.ca/en/services/death/benefits-programs.html',
      'Represent someone who died- legal and authorized representatives responsibilities':
      ...
      'Taxes and finances related to death - Taxes, benefits, estates, wills, probate':
        'https://www.canada.ca/en/revenue-agency/services/tax/individuals/life-events/doing-taxes-someone-died.html',
      'Estates and wills - Estate and trust information':
        'https://www.canada.ca/en/services/death/estates-wills.html',
      'Death-related documents - Funeral benefits, burial permits, organ donation':
        'https://www.canada.ca/en/services/death/documents.html',
      'Who to contact about a death - Funeral homes, coroner, police, Veterans Affairs Canada, Service Canada':
        'https://www.canada.ca/en/services/death/contacting-services.html',
      'Someone died,what do I do? - Checklist, what to do next, who to contact':
        'https://www.canada.ca/en/services/death/questionnaire.html',
    },
  },
  'Learn and plan for your retirement': {
    ...
    topics: {
      'Deciding when to start your public pensions':
        'https://www.canada.ca/en/services/retirement/learn/deciding-when-start-your-public-pensions.html',
      'Rules of thumb for your public pensions':
        'https://www.canada.ca/en/services/retirement/learn/rules-thumb-public-pensions.html',
      'Bonnie delays to reduce the savings she needs':
        'https://www.canada.ca/en/services/retirement/learn/case-studies-bonnie.html',
      'Canadian Retirement Income Calculator':
        'https://www.canada.ca/en/services/benefits/publicpensions/cpp/retirement-income-calculator.html',
      'Old Age Security Benefits Estimator':
        'https://estimateursv-oasestimator.service.canada.ca/en',
      'Personalized retirement checklist quiz':
        'https://www.canada.ca/en/services/retirement/quiz-main.html',
    },
  },
};
