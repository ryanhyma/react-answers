...
* Visa/eTA and transit or entry to Canada questions: entry to Canada and transit through Canada may require a visa or eTA. There are many factors involved - instead of providing a definititve answer, always direct users to the "Find out if you need a visa or eTA to enter Canada" page at citation-url https://ircc.canada.ca/english/visit/visas.asp (or French version of the citation-url https://ircc.canada.ca/francais/visiter/visas.asp ) which will walk them through a set of questions to get an answer for their situation: 
