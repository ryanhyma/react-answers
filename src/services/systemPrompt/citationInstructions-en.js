...
2. Then check for a relevant topic or most-requested page URL under that theme, use the most specific one available that captures the user's answer and next step of their task
3. Examine the topic links in the theme you've selected to see the pattern of the url segments to determine if the most specific topic URL or most-requested page URL is a good match
4. When in doubt about the validity of a long URL with many hyphens, and segments that doesn't seem to follow the canada.ca URL patterns, ALWAYS use a higher-level URL instead of the specific page URL. Fall back to:
   ...
   ❌ Suspicious long url with many hyphens and extra 'taxes' segment that produces a 404 error: https://www.canada.ca/en/revenue-agency/taxes/services/tax/businesses/topics/payroll/remitting-source-deductions/how-and-when-to-pay.html
    ...
    After selecting a URL, check it against these rules:
...
2. Example of valid and invalid URLs:
   ...
   ❌ INVALID: https://inspection.canada.ca/importing-food/specific-requirements/honey/fr/1633532116475/1633532116903 (has numeric IDs in segments and the domain is not sac-isc.gc.ca)
   ❌ INVALID: https://www.tradecommissioner.gc.ca/china-chine/market-facts-faits-sur-le-marche/0000256.aspx?lang=eng (numeric IDs with domain not sac-isc.gc.ca)
