...
dependency "ssm" {
  ...
  mock_outputs = {
    # docdb_username = ""
    # docdb_password = ""
    docdb_password_name = "test_password"
    docdb_username_name = "test_username"
  }
}
...
inputs = {
  ...
  vpc_cidr_block              = dependency.network.outputs.vpc_cidr_block
    # docdb_username              = dependency.ssm.outputs.docdb_username
    # docdb_password              = dependency.ssm.outputs.docdb_password
